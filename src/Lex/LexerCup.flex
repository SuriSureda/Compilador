...
{SPC_DEC}            {
                     ...
                     tokensArray.add(token);
                     return new Symbol(ParserSym.spc_dec);
                     }
